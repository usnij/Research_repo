...
전체 37개 test view 중 **11개 선정**. 선정 기준: 초기 ds=1 K=4/K=8 실험에서 LZT의 WIN/LOSE 패턴이 뚜렷하게 나타나거나(뷰 27, 35, 08, 17), 전체 평균 PSNR이 낮아 어려운 뷰(00, 09, 01), 또는 baseline 대비 명확히 LOSE한 뷰(22, 23, 25, 28)로 구성. K=16 기준 diff로 정렬하면 이 11뷰가 전체 최상위/최하위를 포함하지는 않으나, 씬별 특성(배경 자전거·피아노 유무, 정면/측면)에 따른 패턴 분석에 대표성이 있다.
