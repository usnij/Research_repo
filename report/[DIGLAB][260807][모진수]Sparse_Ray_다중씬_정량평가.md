...
**지난 미팅 (2026-08-05)** — 키워드 3줄
- Bonsai 1개 씬에서 1/64 학습 −0.369 dB, 14.3배 확인
- 단일 씬 결과라 다른 씬에서 같은 배율이 나오는지 미확인
- 희소도 곡선을 그려 1/64의 위치를 확정하기로

**합의 사항 → 상태**
- [완료] 6개 씬으로 확장 (bonsai, counter, room, kitchen, stump, bicycle)
- [완료] 같은 렌더러 기준 비교와 씬별 최고 모델 기준 비교를 분리
- [미착수] 희소도 곡선 (사유: 다중 씬 재현 확인 우선)

**이번 결과 / 막힌 것 / 다음**
- dense 3DGRT 대비: counter −0.110, room −0.321, bonsai −0.369, kitchen −0.662. 가속 14~24배(ds=1)
- 3DGUT 대비 학습 시간이 1.4~2.2배 빠름. stump는 품질도 +0.047
- 막힌 것: ds=4 bicycle은 가속 2.2배, 3DGUT 대비 실내 3개 씬에서 −0.6~−0.8 dB 🔴
- 막힌 것: ray 수를 늘려도 학습 시간이 늘지 않는 현상 원인 미규명 🔴
- 다음: 희소도 곡선 측정으로 1/64의 위치와 ray 수·시간 관계 확정
